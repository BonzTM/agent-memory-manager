...
| Kubernetes deployment | [Helm chart](../deploy/helm/amm/README.md) (`helm repo add amm https://bonztm.github.io/agent-memory-manager`) or [HTTP sidecar example](../deploy/sidecar/README.md) |
