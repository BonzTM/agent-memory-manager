...
4. **Phase 4: Linking** — `merge_duplicates`, `extract_claims`, `enrich_memories`, `rebuild_entity_graph`, `build_entity_briefs` build the knowledge graph.
...
# Stagger extraction/enrichment and entity briefs
